...
app.post('/api/signup', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: newUser.id }, JWT_SECRET, { expiresIn: '24h' });
...
app.get("/api/student/:id", middleware_1.authenticateToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res.json(Object.assign(Object.assign({}, student), { contestHistory: student.contestHistories.map(ch => (Object.assign(Object.assign({}, ch), { date: ch.date.toISOString() }))), submissions: student.submissions.map(s => (Object.assign(Object.assign({}, s), { timestamp: s.timestamp.toISOString() }))) }));
    }
    catch (error) {
