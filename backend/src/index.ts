...
app.post("/api/student", authenticateToken, async (req:Request, res: Response): Promise<any>  => {
  try {
    const data = req.body;
...
app.get("/api/student",authenticateToken, async (req: Request, res: Response): Promise<any> => {
  try {
...
app.get("/api/student/:id",authenticateToken, async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
...
app.put("/api/student/:id",authenticateToken, async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
  const data = req.body;
...
app.delete("/api/student/:id",authenticateToken, async (req: Request, res: Response): Promise<any> => {
  const { id } = req.params;
...
app.patch('/api/student/:id/toggle-reminder', async (req: Request, res: Response): Promise<any> => {
  try {
    const { id } = req.params;
